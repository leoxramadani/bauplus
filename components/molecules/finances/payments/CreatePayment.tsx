                    ...
                    <CommandGroup>
                      {invoice.map((invoice) => (
                        <CommandItem
                          ...
                          key={invoice.value}
                          onSelect={() => {
                            form.setValue("invoice", invoice.value)
                          }}
                        >
                          <Check
                            className={cn(
            ...
            <FormItem>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="cash">Offline Payment</SelectItem>
                </SelectContent>
              </Select>
              <FormMessage />
            </FormItem>
                ...
                <PopoverTrigger asChild>
                  <FormControl>
                    ...
                    >
                      {field.value
                        ? bankAccs.find(
                            (bankAcc) => bankAcc.value === field.value
                          )?.label
                        : "Select Invoice"}
                      <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                    </Button>
                    ...
                    <CommandGroup>
                      {bankAccs.map((bankAcc) => (
                        <CommandItem
                          ...
                          key={bankAcc.value}
                          onSelect={() => {
                            form.setValue("bankAccount", bankAcc.value)
                          }}
                        >
                          <Check
                            className={cn(
