...
import { IInvoice, invoiceSchema } from '@/lib/schema/Finance/invoice';
                    ...
                    <CommandGroup>
                      {companies.map((company) => (
                        <CommandItem
                          ...
                          key={company.value}
                          onSelect={() => {
                            form.setValue("invoiceFor", company.value)
                          }}
                        >
                          <Check
                            className={cn(
          ...
          render={({ field }) => (
            <FormItem className='w-full'>
              ...
              >
                ...
                <SelectContent>
                  {taxValue.map((tax) => (
                                      <SelectItem value={tax.value} key={tax.value}>{tax.label}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
              <FormMessage />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='w-full sm:col-span-2'>
                ...
                <FormControl className="relative">
                  <Textarea placeholder="Invoice description..." rows={5} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
