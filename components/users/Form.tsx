...
const UsersForm = ({
  ...
  const [companiesWithPrivileges, setCompaniesWithPrivileges] = useState<
    CompanyWithRoleAndPrivileges[]
  >([]);
        ...
        <div className="flex flex-col gap-3 my-auto">
          ...
          <div className="doubleInput-container">
            <div className="flex flex-col gap-1">
              ...
              />
              {errors.firstName && (
                <p className="text-red-600">{t(errors.firstName.message)}</p>
              )}
            </div>
            <div className="flex flex-col gap-1">
              ...
              />
              {errors.lastName && (
                <p className="text-red-600">{t(errors.lastName.message)}</p>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            />
            {errors.username && (
              <p className="text-red-600">{t(errors.username.message)}</p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            />
            {errors.email && (
              <p className="text-red-600">{t(errors.email.message)}</p>
            )}
          </div>
          ...
          <div className="doubleInput-container">
            ...
            <div className="flex flex-col gap-1">
              ...
              />
              {errors.phoneNumber && (
                <p className="text-red-600">{t(errors.phoneNumber.message)}</p>
              )}
            </div>
            {/* Email */}
            <div className="flex flex-col gap-1">
