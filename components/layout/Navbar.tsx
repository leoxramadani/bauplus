...
const Dropdown = ({
  ...
  return (
    <div
      ...
      className={`relative rounded-xl px-3 border py-1 cursor-pointer bg-slate-800 text-white items-center align-middle`}
    >
      {children}
...
const Navbar = ({
  ...
  return (
    <nav className={`bg-[#1A202E] p-2 flex flex-row justify-between`}>
      ...
      <Dropdown
        content={
          <div className="absolute right-0 border p-2 rounded-[0.5rem] mt-3.5 bg-slate-800 text-white font-medium">
      ...
      >
        <div className="flex flex-row gap-1.5 items-center py-[0.435rem] mt-0.5 text-sm justify-center align-middle leading-none text-white">
          <User width={20} />
