...
export const GET_ALL_CLIENTS = BASE_URL + `/api/Client/GetAllClients`;

export const DELETE_CLIENT = BASE_URL + `/api/Client`;

export const GET_ALL_CLIENT_TYPES =
  BASE_URL + `/api/Clienttype/GetallClientType`;

export const UPDATE_CLIENTS = BASE_URL + `/api/Clienttype`;
